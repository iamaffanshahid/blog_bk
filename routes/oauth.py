...
from routes.schemas import UserInDB, UserSchema
from datetime import datetime, timedelta, timezone
from typing import Union
from routes.schemas import TokenData
import jwt
from jwt.exceptions import InvalidTokenError
from routes.schemas import Token
...
async def register_user(user: SignUp, db: Session = Depends(get_db)):
    ...
    if exsisted_user:
        raise HTTPException(
            ...
            detail="User Already Exsist",
        )

    print("exsisted_user", exsisted_user)

    user_object = insert_user(db=db, user=user)
