...
async def post_get(db: Session = Depends(get_db)):
    ...
    content = {"data": post_object, "message": "Ok", "status": status.HTTP_200_OK}
    return content
...
async def post_delete(
    ...
    content = {"data": post_id, "message": "Deleted", "status": status.HTTP_200_OK}
    return content, {"token": token}
...
async def update_post(
    ...
    content = {"data": post_id, "message": "updated", "status": status.HTTP_200_OK}
    return content, {"token": token}
